...
namespace Nop.Services.Media
{
    ...
    public partial class PictureService : IPictureService
    {
        ...
        public string PublicIP { get { return "kamsindustrial.com"; } }
        ...
        protected virtual string GetThumbLocalPath(string thumbFileName)
        {
            ...
            if (thumbFilePath.ToLower().Contains("localhost"))
            {
                thumbFilePath = thumbFilePath.Replace("localhost", PublicIP);
            }
        ...
        protected virtual string GetImagesPathUrl(string storeLocation = null)
        {
            ...
            if (imagesPathUrl.ToLower().Contains("localhost"))
            {
                imagesPathUrl = imagesPathUrl.Replace("localhost", PublicIP);
            }
        ...
        protected virtual string GetThumbUrl(string thumbFileName, string storeLocation = null)
        {
            ...
            {
                url = url.Replace("localhost", PublicIP);
            }
        ...
        {
            var path =  _fileProvider.GetAbsolutePath("images", fileName);

            if (path.ToLower().Contains("localhost"))
            {
                path = path.Replace("localhost", PublicIP);
            }
