...
namespace Nop.Data.Mapping.Catalog
{
    ...
    public partial class ProductMap : NopEntityTypeConfiguration<Product>
    {
        ...
        public override void Configure(EntityTypeBuilder<Product> builder)
        {
            ...
            builder.Property(product => product.Price1).HasColumnType("decimal(18, 4)");
            builder.Property(product => product.Price2).HasColumnType("decimal(18, 4)");
            builder.Property(product => product.Price3).HasColumnType("decimal(18, 4)");
            builder.Property(product => product.Price4).HasColumnType("decimal(18, 4)");
            builder.Property(product => product.ShowPrice).HasMaxLength(400);
