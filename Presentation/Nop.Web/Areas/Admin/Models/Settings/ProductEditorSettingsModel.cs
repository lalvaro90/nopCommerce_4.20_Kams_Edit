...
namespace Nop.Web.Areas.Admin.Models.Settings
{
    ...
    public partial class ProductEditorSettingsModel : BaseNopModel, ISettingsModel
    {
        ...
        [NopResourceDisplayName("Admin.Configuration.Settings.ProductEditor.Price")]
        public bool Price { get; set; }

        [NopResourceDisplayName("Admin.Configuration.Settings.ProductEditor.Price1")]
        public bool Price1 { get; set; }

        [NopResourceDisplayName("Admin.Configuration.Settings.ProductEditor.Price2")]
        public bool Price2 { get; set; }

        [NopResourceDisplayName("Admin.Configuration.Settings.ProductEditor.Price3")]
        public bool Price3 { get; set; }

        [NopResourceDisplayName("Admin.Configuration.Settings.ProductEditor.Price4")]
        public bool Price4 { get; set; }

        [NopResourceDisplayName("Admin.Configuration.Settings.ProductEditor.ShowPrice")]
