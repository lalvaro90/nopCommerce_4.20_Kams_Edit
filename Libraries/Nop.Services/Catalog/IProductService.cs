...
namespace Nop.Services.Catalog
{
    ...
    public partial interface IProductService
    {
        ...
        /// <summary>
        /// Update the visible price value to the one value selected
        /// </summary>
        /// <param name="fieldName">Options are Price1, Price2, Price3 or Price4</param>
        void UpdateProductVisiblePrice(string fieldName);
