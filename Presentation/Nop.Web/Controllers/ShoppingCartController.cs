...
namespace Nop.Web.Controllers
{
    public partial class ShoppingCartController : BasePublicController
    {
        ...
        [FormValueRequired("credit")]
        public virtual IActionResult RequestCredit()
        {
            ...
            _workContext.TempOrderIt = or.Id;
            _notificationService.SuccessNotification("Solicitud de credito enviada a estudio satisfactoriamente", false);
